...
## Notas para quien modera (no leer al participante)

- No reveles qué colegios dan prioridad a esta familia ni cómo funciona el algoritmo — que la persona lo descubra a través de la página.
- No confirmes ni corrijas si el participante piensa que cierto orden es "más seguro"; solo pregunta "¿por qué lo pusiste ahí?" y anota la respuesta.
- Presta especial atención a dónde ubica el **Colegio San Martín** y qué dice al respecto, antes y después de ver cualquier advertencia relacionada con ese colegio — es el punto más importante del caso (ver §3.1 del documento del caso de estudio).
- Si pregunta si "conviene" poner primero el colegio que más quiere o el que tiene más posibilidades, no respondas directamente; anota la pregunta, es información valiosa para el análisis.

---

*Pendiente de tu revisión: tono, extensión, y si prefieres que la ficha de apoyo se entregue en papel, en pantalla aparte, o integrada al flujo mismo del prototipo.*
