...
> **Corrección de fuentes (2026-09-08 — revisión bibliográfica `investigacion_guias_ux_transparencia_sae.md`, verificada contra las fuentes primarias).** El bloque "RISK-NUM" mezclaba fuentes de tres asuntos distintos. Deben separarse:
> - **Icon arrays y baja numeracidad:** Galesic, Garcia-Retamero & Gigerenzer (2009), *Using icon arrays to communicate medical risks: overcoming low numeracy*, *Health Psychology* 28(2), 210–216 — [PubMed 19290713](https://pubmed.ncbi.nlm.nih.gov/19290713/). (Es el paper del enlace del Max Planck de arriba.) Evidencia **del dominio médico**: fundamenta *explorar* una representación visual, no demuestra su eficacia en familias del SAE.
> - **Formato de frecuencia natural ("X de cada 100"):** Visschers, Meertens, Passchier & de Vries (2009), *Probability information in risk communication: a review* — [PubMed 19000070](https://pubmed.ncbi.nlm.nih.gov/19000070/); y una revisión sistemática más reciente ([PMC11067312](https://pmc.ncbi.nlm.nih.gov/articles/PMC11067312/)). El efecto **depende del contexto y de la tarea**; la afirmación segura es "puede facilitar la interpretación, particularmente con diferencias de numeracidad; hay que validarlo con la población objetivo", no "siempre es mejor que un porcentaje".
> - **Visualización de incertidumbre (fuente complementaria, no de icon arrays):** Karagappa et al. (2024), *Enhancing Uncertainty Communication in Time Series Predictions* — [arXiv:2408.12365](https://arxiv.org/abs/2408.12365). **Verificado:** este paper es sobre visualización de incertidumbre en **predicciones de series temporales**, no sobre icon arrays ni frecuencias naturales; se citaba mal como "síntesis sobre baja numeracidad".

Fuentes (corregidas): [Galesic et al. 2009 — icon arrays / baja numeracidad (Max Planck)](https://pure.mpg.de/rest/items/item_2099767_4/component/file_2562291/content) · [Visschers et al. 2009 — probability information in risk communication (review)](https://pubmed.ncbi.nlm.nih.gov/19000070/) · [revisión sistemática de comunicación de riesgo verbal/numérica (PMC11067312)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11067312/) · [Karagappa et al. 2024 — visualización de incertidumbre en series temporales (complementaria)](https://arxiv.org/abs/2408.12365).
...
- Indicador de progreso visible en formularios de más de tres pasos. El stepper accesible del prototipo ya cumple esto. ⚠️ **La cifra "reduce el abandono entre 20-25 %" NO tiene fuente primaria verificable** (revisión 2026-09-08): proviene de blogs profesionales (WeWeb / Venture Harbour), no de un estudio. **No debe citarse como hecho en la memoria** mientras no se identifique su origen; el patrón en sí (indicador de progreso) sí es buena práctica documentada en sistemas de servicio público.
- Guardado y reanudación explícitos ("Borrador guardado" + aviso de reanudación): buena práctica en trámites; **en el prototipo se retiró a propósito** (la lista se arma desde cero en cada visita) para no contaminar la prueba comparativa de lista fija — exclusión metodológicamente justificada, no un incumplimiento.
...
> **Fuente preferida para un trámite público (2026-09-08):** el **GOV.UK Design System** es más pertinente y mejor documentado (declara investigación con usuarios, incluidas personas con baja alfabetización digital) que los blogs comerciales. Patrones directamente aplicables: [question pages](https://design-system.service.gov.uk/patterns/question-pages/) (pedir solo lo necesario, volver atrás, conservar datos ante error), [check answers](https://design-system.service.gov.uk/patterns/check-answers/) (revisar antes de enviar — paso 3 del flujo), [confirmation pages](https://design-system.service.gov.uk/patterns/confirmation-pages/) (número de referencia + "qué ocurre después" + registro de la transacción — el comprobante), [validation](https://design-system.service.gov.uk/patterns/validation/).

Fuentes: [GOV.UK Design System — Patterns](https://design-system.service.gov.uk/patterns/) (preferida). Secundarias / práctica profesional, sin evidencia académica fuerte: [Multi-Step Form Design (WeWeb, 2026)](https://www.weweb.io/blog/multi-step-form-design); [58 Form Design Best Practices (Venture Harbour, 2026)](https://ventureharbour.com/form-design-best-practices/).
